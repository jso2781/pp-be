...
public class DosageJsonArrayTypeHandler extends JsonListTypeHandler<DurSearchRoomRVO.DosageItem> {
    public DosageJsonArrayTypeHandler() {
        super(new TypeReference<List<DurSearchRoomRVO.DosageItem>>() {});
    }
}