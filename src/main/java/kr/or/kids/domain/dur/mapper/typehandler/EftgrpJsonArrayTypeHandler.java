...
public class EftgrpJsonArrayTypeHandler extends JsonListTypeHandler<DurSearchRoomRVO.EftgrpItem> {
    public EftgrpJsonArrayTypeHandler() {
        super(new TypeReference<List<DurSearchRoomRVO.EftgrpItem>>() {});
    }
}