...
// inst_news_json_array
@MappedTypes({List.class})
@MappedJdbcTypes(JdbcType.OTHER) // PostgreSQL json/jsonb는 보통 OTHER로 들어옴
public class InstNewsJsonArrayTypeHandler extends JsonListTypeHandler<IntegratedSearchRVO.SearchItem> {
    public InstNewsJsonArrayTypeHandler() {
