...
public class CpctJsonArrayTypeHandler extends JsonListTypeHandler<DurSearchRoomRVO.CpctItem> {
    public CpctJsonArrayTypeHandler() {
        super(new TypeReference<List<DurSearchRoomRVO.CpctItem>>() {});
    }
}