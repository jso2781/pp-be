...
// info_open_json_array
@MappedTypes({List.class})
@MappedJdbcTypes(JdbcType.OTHER) // PostgreSQL json/jsonb는 보통 OTHER로 들어옴
public class InfoOpenJsonArrayTypeHandler extends JsonListTypeHandler<IntegratedSearchRVO.SearchItem> {
    public InfoOpenJsonArrayTypeHandler() {
