...
public class ConcJsonArrayTypeHandler extends JsonListTypeHandler<DurSearchRoomRVO.ConcItem> {
    public ConcJsonArrayTypeHandler() {
        super(new TypeReference<List<DurSearchRoomRVO.ConcItem>>() {});
    }
}