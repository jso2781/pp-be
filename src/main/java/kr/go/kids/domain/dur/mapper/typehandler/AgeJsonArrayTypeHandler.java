...
public class AgeJsonArrayTypeHandler extends JsonListTypeHandler<DurSearchRoomRVO.AgeItem> {
    public AgeJsonArrayTypeHandler() {
        super(new TypeReference<List<DurSearchRoomRVO.AgeItem>>() {});
    }
}