...
public class DurMyDrugInfoController {
    ...
    public ResponseEntity<ApiPrnDto> selectDurMyDrugInfoList(@RequestBody DurMyDrugInfoPVO durMyDrugInfoPVO) {
        ApiPrnDto apiPrnDto = durMyDrugInfoService.selectDurMyDrugInfoList(durMyDrugInfoPVO);
