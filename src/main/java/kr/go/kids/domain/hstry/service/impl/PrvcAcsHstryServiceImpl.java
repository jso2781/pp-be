package kr.go.kids.domain.hstry.service.impl;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;

import kr.go.kids.domain.hstry.mapper.PrvcAcsHstryMapper;
import kr.go.kids.domain.hstry.service.PrvcAcsHstryService;
import kr.go.kids.domain.hstry.vo.PrvcAcsHstryDVO;
import kr.go.kids.domain.hstry.vo.PrvcAcsHstryPVO;
import kr.go.kids.domain.hstry.vo.PrvcAcsHstryRVO;
