package kr.go.kids.domain.trm.service.impl;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;

import kr.go.kids.domain.trm.mapper.TrmMapper;
import kr.go.kids.domain.trm.service.TrmService;
import kr.go.kids.domain.trm.vo.TrmDVO;
import kr.go.kids.domain.trm.vo.TrmPVO;
import kr.go.kids.domain.trm.vo.TrmRVO;
